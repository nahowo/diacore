...
public class MealLogRequest {
  ...
  */
  @NotNull 
  @Schema(name = "carbohydrateG", example = "45", description = "섭취한 탄수화물 질량(g)", requiredMode = Schema.RequiredMode.REQUIRED)
  ...
  */
  ...
  @Schema(name = "foodDesc", example = "쌀밥 140g, 계란프라이", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
