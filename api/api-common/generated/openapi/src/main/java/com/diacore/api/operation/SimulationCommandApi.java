...
@Generated(value = "org.openapitools.codegen.languages.SpringCodegen", date = "2026-07-28T11:26:04.544765+09:00[Asia/Seoul]", comments = "Generator version: 7.5.0")
public interface SimulationCommandApi {
        ...
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "{ \"recommendedAction\" : { \"actionType\" : \"MAINTAIN\", \"suggestedValue\" : 15.0, \"message\" : \"고강도 운동 전 저혈당 예방을 위해 15g의 탄수화물 섭취를 권장합니다.\" }, \"reason\" : \"BG 125, IOB 1.2. Planned exercise HIGH reduces ISF. 15g carbs needed to stay above 90.\", \"eventualBg\" : 110, \"trajectories\" : [ { \"zeroTempPred\" : 1, \"offsetMinutes\" : 15, \"uamPred\" : 5, \"cobPred\" : 6, \"simulatedPred\" : 5, \"iobPred\" : 0 }, { \"zeroTempPred\" : 1, \"offsetMinutes\" : 15, \"uamPred\" : 5, \"cobPred\" : 6, \"simulatedPred\" : 5, \"iobPred\" : 0 } ], \"snoozeBg\" : 95 }";
